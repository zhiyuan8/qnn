...
class ConverterFrontend(ConverterBase, ABC):
    ...
    class ArgParser(ConverterBase.ArgParser):
        def __init__(self, **kwargs):
            ConverterFrontend.qairt_converter = False
    ...
    class ArgParserv2(ConverterBase.ArgParserv2):
        def __init__(self, **kwargs):
            ConverterFrontend.qairt_converter = True
            ...
            self.add_optional_argument('--preserve_io_datatype', default=False, action="store_true",
    ...
    def __init__(self, args,
        ...
        self.qairt_converter = ConverterFrontend.qairt_converter
